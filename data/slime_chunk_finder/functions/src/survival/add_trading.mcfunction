...
# summon minecraft:item ~ ~ ~ {Item: {id:"minecraft:slime_ball",Count:1b,tag:{display:{Name:'{text:"Slime Chunk Finder",italic:false}',Lore:["\"Mystical artifact\"","\"Senses slime stability\""]},Enchantments:[{id:unbreaking,lvl:1}],SlimeFinder:1b,HideFlags:1b}}}
