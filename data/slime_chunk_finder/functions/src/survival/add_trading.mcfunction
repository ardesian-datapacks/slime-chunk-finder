...
execute if entity @e[tag=RandSlime,tag=pass,tag=selected] run data modify entity @s Offers.Recipes append value {sell: {id: "minecraft:slime_ball", Count: 1b, tag: { display:{Name:"{\"text\":\"Slime Chunk Finder\",\"italic\":\"false\"}", Lore: ["\"A mystical artifact that senses slimy chunks.\""]}, Enchantments: [{id: unbreaking, lvl: 1}], SlimeFinder: 1b, HideFlags: 1b }}, buy: {id: "minecraft:emerald", Count: 36b}}
